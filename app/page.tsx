    ...
    <>
      <Container className="mt-9">
        <div className="max-w-2xl">
          <h1 className="text-4xl font-bold tracking-tight text-zinc-800 dark:text-zinc-100 sm:text-5xl">Frontend Engineer, and Amateur UI/UX Designer</h1>
          ...
          <div className="mt-6 flex gap-6">
            ...
            <SocialLink href="https://www.linkedin.com/in/dzun-n/" aria-label="Follow on LinkedIn" icon={LinkedInIcon} target="_blank" />
