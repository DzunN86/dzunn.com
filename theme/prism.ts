...
*/
  ...
  .highlight-line {
    margin-left: -16px;
    margin-right: -16px;
    background-color: rgb(59 130 246 / 7%); /* Set highlight bg color */
...
`;
const prismLineHighlightDark = css`
  pre {
    overflow-x: auto;
  }
...
const rehypeCodeTitlesLight = css`
  .rehype-code-title {
    display: flex;
    align-items: center;
...
const rehypeCodeTitlesDark = css`
  .rehype-code-title {
    display: flex;
    align-items: center;
    justify-content: space-between;
...
export const prismDarkTheme = css`
  ${prismBaseTheme};
  ${prismLineHighlightDark};
  ${rehypeCodeTitlesDark};
  :not(pre) > code[class*="language-"] {
    background: #011627;
  }
  .token.attr-name {
