...
function MobileNavigation(props: ComponentPropsWithoutRef<"nav">) {
  return (
    <Popover {...props}>
...
function NavItem({ href, children }: { href: string; children: React.ReactNode }) {
  ...
  return (
    <li>
      <Link href={href} className={clsx("relative block px-3 py-2 transition", isActive ? "text-orange-500 dark:text-orange-400" : "hover:text-orange-500 dark:hover:text-orange-400")}>
        {children}
        {isActive && (
...
function AvatarContainer({ className, ...props }: ComponentPropsWithoutRef<"div">) {
  return (
    <div className={clsx(className, "h-10 w-10 rounded-full bg-white/90 p-0.5 shadow-lg shadow-zinc-800/5 ring-1 ring-zinc-900/5 backdrop-blur dark:bg-zinc-800/90 dark:ring-white/10")} {...props} />
  );
}
